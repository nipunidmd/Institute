...
<body>
 ...
 <div class="panel panel-default">
    <div class="panel-heading">Lecturer Details</div>
...
<div class="box-body">
	...
	<form method = "POST" role= "form"  class="form-horizontal">
		...
		<a href="http://localhost/Institute/public/lecturer/lecturer_list" class="btn btn-primary pull-left"> Back</a><!--back to Lecturer list-->
