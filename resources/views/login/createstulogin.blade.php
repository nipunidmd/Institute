          ...
          <div class="x_panel">
            ...
            <input type="hidden" name="_token" value = "{{csrf_token() }}">
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="sid">Student_ID<span class="required">*</span>
                </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="form-control" name='sid' placeholder="Student_ID" class="form-control col-md-7 col-xs-12"required>        
                  ...
                  <!--check that sid-->
                  @if($errors->has('sid'))
                  <span class="help-block">{{$errors->first('sid')}}</span>
                  @endif
              </div> 
              <br>
