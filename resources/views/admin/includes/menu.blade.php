                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-user"></i>Add New<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="http://localhost:8080/Institute/public/student/student_add">Add Student</a></li>
                  ...
                  <li><a><i class="fa fa-sign-in"></i> Create Login <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="tables.html">Student Login</a></li>
                      <li><a href="tables_dynamic.html">Lecturer Login</a></li>
                    </ul>
                  </li>
